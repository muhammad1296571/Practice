...
@section('main')
    <div class="container mx-auto px-4 sm:px-16 mt-10">
        ...
        <div class="py-8">
            <div>
                <h2 class="text-3xl font-semibold leading-tightc text-orange-500">All Declined User </h2>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 bg-white text-sm">
                                        ...
                                        <span
                                            ...
                                            <span class="relative cursor-pointer">Declined</span>
                                        </span>
                                    </td>
                                     <td class="px-5 py-5 bg-white text-sm">
                                        <span
                                       ...
                                       <a href="{{url('approved_user', $item->id )}}"> <span class="relative cursor-pointer">Approved</span></a>
                                        </span>
                                        <span
                                            class="relative inline-block px-3 py-1 font-semibold text-red-900 leading-tight">
                                            <span aria-hidden
